...
<!-- provenance: vendored 2026-07-05 from client-B/frontend/.claude/skills/web-design-guidelines (symlinked to .agents/skills/web-design-guidelines); also existed in (byte-identical or whitespace-only variants): CodeHouseSolutions/InternalWork/smsMarketing, client-D/mobileapp, client-A, client-A/mvp; upstream origin: vercel-labs/web-interface-guidelines -->
